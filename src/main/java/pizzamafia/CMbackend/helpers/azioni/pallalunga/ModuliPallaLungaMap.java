...
public class ModuliPallaLungaMap {
    ...
    // ----------------- PALLA LUNGA 1 --------------------
    public static final Map<String, List<Ruolo>> PALLALUNGA1_MAP = Map.of(
            "4-4-2(1)", List.of(
    ...
    // ----------------- PALLA LUNGA 2 --------------------
    public static final Map<String, List<Ruolo>> PALLALUNGA2_MAP = Map.of(
            "4-4-2(1)", List.of(
                    Ruolo.DIFENSORE_CENTRALE,       // Passatore 1
                    Ruolo.CENTROCAMPISTA_CENTRALE,  // Ricevente 1 / Passatore lungo
    ...
    // ----------------- PALLA LUNGA 3 --------------------
    public static final Map<String, List<Ruolo>> PALLALUNGA3_MAP = Map.of(
            "4-4-2(1)", List.of(
                    Ruolo.DIFENSORE_CENTRALE,       // Passatore 1
    ...
    // ----------------- PALLA LUNGA 4 --------------------
    public static final Map<String, List<Ruolo>> PALLALUNGA4_MAP = Map.of(
            "4-4-2(1)", List.of(
